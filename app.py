...
def main():
    ...
    if mode == "📊 Multi-Physics Dashboard":
        ...
        with col_long:
            ...
            fig_n = plt.figure(figsize=(4.5, 1.3))
            ax_n = fig_n.add_axes([0.18, 0.28, 0.72, 0.58])
            ax_n.plot(z_grid, N_prof / 1e18, color="#ff7b72", linewidth=2.0, label="N(z)")
            ax_n.set_title("Carrier Density N(z)", color="white", fontsize=8.5, fontweight="bold")
            ax_n.set_xlabel("z Position (μm)", color="#8b949e", fontsize=7.0)
            ax_n.set_ylabel("N (10^18 cm^-3)", color="#8b949e", fontsize=7.0)
            ax_n.grid(True, linestyle="--", alpha=0.3, color="#233554")
            ax_n.set_facecolor("#172a45")
            fig_n.patch.set_facecolor("#0d1117")
            ax_n.tick_params(colors="#8b949e", labelsize=7.0)
            for spine in ax_n.spines.values():
                spine.set_color("#30363d")
            st.pyplot(fig_n, use_container_width=True)
            
            # Plot 2: Optical Power P(z)
            fig_p = plt.figure(figsize=(4.5, 1.3))
            ax_p = fig_p.add_axes([0.18, 0.28, 0.72, 0.58])
            ax_p.plot(z_grid, P_prof * 1000.0, color="#64ffda", linewidth=2.0, label="P(z)")
            ax_p.set_title("Optical Power Profile P(z)", color="white", fontsize=8.5, fontweight="bold")
            ax_p.set_xlabel("z Position (μm)", color="#8b949e", fontsize=7.0)
            ax_p.set_ylabel("Power (mW)", color="#8b949e", fontsize=7.0)
            ax_p.grid(True, linestyle="--", alpha=0.3, color="#233554")
            ax_p.set_facecolor("#172a45")
            fig_p.patch.set_facecolor("#0d1117")
            ax_p.tick_params(colors="#8b949e", labelsize=7.0)
        ...
        with col_trans2d:
            ...
            fig_m2d = plt.figure(figsize=(4.5, 1.3))
            ax_m2d = fig_m2d.add_axes([0.18, 0.28, 0.72, 0.58])
            ...
            ax_m2d.set_title("Mode Intensity Shape |Ψ|²", color="white", fontsize=8.5, fontweight="bold")
            ax_m2d.set_xlabel("x width (μm)", color="#8b949e", fontsize=7.0)
            ax_m2d.set_ylabel("y height (μm)", color="#8b949e", fontsize=7.0)
            ax_m2d.tick_params(colors="#8b949e", labelsize=7.0)
            ...
            fig_t2d = plt.figure(figsize=(4.5, 1.3))
            ax_t2d = fig_t2d.add_axes([0.18, 0.28, 0.72, 0.58])
            ...
            ax_t2d.set_title("Temperature Heat Map T(x,y)", color="white", fontsize=8.5, fontweight="bold")
            ax_t2d.set_xlabel("x width (μm)", color="#8b949e", fontsize=7.0)
            ax_t2d.set_ylabel("y height (μm)", color="#8b949e", fontsize=7.0)
            ax_t2d.tick_params(colors="#8b949e", labelsize=7.0)
        ...
        with col_trans1d:
            ...
            fig_sh = plt.figure(figsize=(4.5, 1.3))
            ax_sh = fig_sh.add_axes([0.18, 0.28, 0.72, 0.58])
            I_horiz = norm_power * np.exp(-tx**2 / 1.5**2)
            ax_sh.plot(tx, I_horiz, color="#ffcc00", linewidth=2.0, label="Horizontal Mode slice")
            ax_sh.set_title("Horizontal Cut Mode Profile", color="white", fontsize=8.5, fontweight="bold")
            ax_sh.set_xlabel("x width (μm)", color="#8b949e", fontsize=7.0)
            ax_sh.set_ylabel("Intensity", color="#8b949e", fontsize=7.0)
            ax_sh.grid(True, linestyle="--", alpha=0.3, color="#233554")
            ax_sh.set_facecolor("#172a45")
            fig_sh.patch.set_facecolor("#0d1117")
            ax_sh.tick_params(colors="#8b949e", labelsize=7.0)
            ...
            fig_sv = plt.figure(figsize=(4.5, 1.3))
            ax_sv = fig_sv.add_axes([0.18, 0.28, 0.72, 0.58])
            I_vert = norm_power * np.exp(-ty**2 / 0.5**2)
            ax_sv.plot(ty, I_vert, color="#ff33cc", linewidth=2.0, label="Vertical Mode slice")
            ax_sv.set_title("Vertical Cut Mode Profile", color="white", fontsize=8.5, fontweight="bold")
            ax_sv.set_xlabel("y height (μm)", color="#8b949e", fontsize=7.0)
            ax_sv.set_ylabel("Intensity", color="#8b949e", fontsize=7.0)
            ax_sv.grid(True, linestyle="--", alpha=0.3, color="#233554")
            ax_sv.set_facecolor("#172a45")
            fig_sv.patch.set_facecolor("#0d1117")
            ax_sv.tick_params(colors="#8b949e", labelsize=7.0)
        ...
        with col_slice_mode:
            fig_m2d_z = plt.figure(figsize=(4.5, 1.3))
            ax_m2d_z = fig_m2d_z.add_axes([0.18, 0.28, 0.72, 0.58])
            ...
            ax_m2d_z.set_title(f"Local Optical Mode at z = {z_grid[idx]:.1f} μm", color="white", fontsize=8.5, fontweight="bold")
            ax_m2d_z.set_xlabel("x width (μm)", color="#8b949e", fontsize=7.0)
            ax_m2d_z.set_ylabel("y height (μm)", color="#8b949e", fontsize=7.0)
            ax_m2d_z.tick_params(colors="#8b949e", labelsize=7.0)
        ...
        with col_slice_temp:
            fig_t2d_z = plt.figure(figsize=(4.5, 1.3))
            ax_t2d_z = fig_t2d_z.add_axes([0.18, 0.28, 0.72, 0.58])
            ...
            ax_t2d_z.set_title(f"Local Temperature at z = {z_grid[idx]:.1f} μm", color="white", fontsize=8.5, fontweight="bold")
            ax_t2d_z.set_xlabel("x width (μm)", color="#8b949e", fontsize=7.0)
            ax_t2d_z.set_ylabel("y height (μm)", color="#8b949e", fontsize=7.0)
            ax_t2d_z.tick_params(colors="#8b949e", labelsize=7.0)
        ...
        with col_3d_mode:
            fig_3d_m = plt.figure(figsize=(5, 1.8))
        ...
        with col_3d_temp:
            fig_3d_t = plt.figure(figsize=(5, 1.8))
